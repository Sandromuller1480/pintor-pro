        ...
        return (
            <div className="bg-slate-50 min-h-screen flex items-center justify-center px-4">
                <div className="max-w-xl w-full bg-white p-10 rounded-[32px] border border-slate-100 shadow-sm text-center">
                    <h1 className="text-2xl font-black text-slate-900 mb-4">Perfil nÃ£o encontrado</h1>
                    <p className="text-slate-500 mb-8">O pintor solicitado nÃ£o estÃ¡ disponÃ­vel ou foi removido.</p>
                    <button
        ...
        <div className="bg-slate-50 min-h-screen">
                        ...
                        <div className="flex gap-6 items-end">
                            ...
                            <div className="pb-2">
                                ...
                                <div className="flex items-center gap-4 text-white/80 text-sm font-medium">
                                    <span className="flex items-center gap-1"><Star className="w-4 h-4 text-yellow-400 fill-yellow-400" /> {painter.rating} ({painter.reviewsCount} avaliaÃ§Ãµes)</span>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-8 space-y-12">
                        ...
                        <div className="flex gap-8 border-b border-slate-200 overflow-x-auto">
                            {(['portfolio', 'about', 'reviews'] as const).map(tab => (
                                ...
                                >
                                    {tab === 'portfolio' ? 'PortfÃ³lio' : tab === 'about' ? 'Sobre o Pintor' : 'AvaliaÃ§Ãµes'}
                                </button>
                            ))}
                        </div>
                                ...
                                {[1, 2, 3, 4].map(id => (
                                    <div key={id} className="bg-white rounded-[32px] overflow-hidden shadow-sm border border-slate-100 group cursor-pointer hover:shadow-xl transition">
                                        <div className="relative h-60">
                                            ...
                                            <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-wider text-[#9A077B] flex items-center">
                                                <Camera className="w-3 h-3 mr-1" /> Antes & Depois
                                            </div>
                                        </div>
                                        <div className="p-6">
                                            <h4 className="font-bold text-lg mb-2">Pintura Comercial de Alto PadrÃ£o</h4>
                                            <p className="text-slate-500 text-sm mb-4 line-clamp-2">RevitalizaÃ§Ã£o completa de fachada utilizando tecnologia airless e acabamento epÃ³xi.</p>
                        ...
                        {activeTab === 'about' && (
                            <div className="bg-white p-10 rounded-[40px] shadow-sm border border-slate-100 space-y-8">
                                <div className="prose prose-slate max-w-none">
                                    <h3 className="text-2xl font-black mb-4">A excelÃªncia em cada demÃ£o</h3>
                                    <p className="text-slate-600 leading-relaxed text-lg">
                                        Atuo no mercado hÃ¡ mais de 15 anos, com foco em projetos residenciais de luxo e ambientes corporativos que exigem rigor tÃ©cnico e acabamento impecÃ¡vel. Meu compromisso Ã© transformar espaÃ§os atravÃ©s da cor e da proteÃ§Ã£o, utilizando sempre os melhores materiais do mercado.
                                    </p>
                                </div>
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                    <div className="p-4 bg-slate-50 rounded-2xl">
                                        <div className="text-xs font-bold text-slate-400 uppercase mb-1">ExperiÃªncia</div>
                                ...
                                <div>
                                    <h4 className="font-bold mb-4 flex items-center"><CheckCircle className="w-5 h-5 mr-2 text-[#9A077B]" /> CertificaÃ§Ãµes</h4>
                            ...
                            <div className="space-y-6">
                                {[1, 2, 3].map(id => (
                                    <div key={id} className="bg-white p-8 rounded-[32px] shadow-sm border border-slate-100">
                                        <div className="flex justify-between items-start mb-4">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <span className="text-xs text-slate-400">HÃ¡ 2 meses</span>
                                                </div>
                                            </div>
                                        ...
                                        <p className="text-slate-600 leading-relaxed italic">"Trabalho excepcional. Pontualidade britÃ¢nica e um acabamento que nunca vi igual. Recomendo muito o Roberto para quem busca perfeiÃ§Ã£o."</p>
                                    </div>
                                ))}
                            </div>
                        )}
                    ...
                    {/* AÃ§Ãµes Fixas da Barra Lateral */}
                    <aside className="lg:col-span-4">
                        <div className="sticky top-28 space-y-6">
                            <div className="bg-white p-8 rounded-[40px] shadow-2xl border border-slate-100">
                                <h3 className="text-xl font-black mb-6">Solicitar OrÃ§amento</h3>
                                <div className="space-y-4 mb-8">
                                    ...
                                    <div className="flex items-center justify-between text-sm">
                                        ...
                                        <span className="font-bold text-[#9A077B]">DisponÃ­vel em 10 dias</span>
                                    </div>
                                    <div className="flex items-center justify-between text-sm">
                                        <span className="text-slate-500">Meios de Pagamento</span>
                                        <span className="font-bold">CartÃ£o, Pix, Boleto</span>
                                    </div>
                                </div>
                                ...
                                <p className="text-[10px] text-slate-400 text-center mt-6 uppercase tracking-widest font-bold flex items-center justify-center">
                                    <Shield className="w-3 h-3 mr-1" /> ContrataÃ§Ã£o Segura PINTOR PRO
                                </p>
                            </div>
                            ...
                            <div className="bg-slate-900 p-8 rounded-[40px] text-white overflow-hidden relative">
                                <div className="relative z-10">
                                    ...
                                    <h4 className="font-black text-lg mb-4">ProteÃ§Ã£o de Pagamento</h4>
                                    <p className="text-slate-400 text-xs leading-relaxed mb-6">Contrate atravÃ©s da plataforma e garanta que seu dinheiro sÃ³ seja liberado apÃ³s a conclusÃ£o da obra.</p>
