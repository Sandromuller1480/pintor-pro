        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 relative">
          ...
          {steps[view].map((step, idx) => (
            <div key={idx} className="relative z-10 flex flex-col items-center text-center group">
              <div className="w-24 h-24 bg-white border-4 border-slate-50 rounded-[32px] flex items-center justify-center text-[#9A077B] shadow-lg group-hover:scale-110 group-hover:bg-[#9A077B] group-hover:text-white transition duration-500 mb-10">
                {step.icon}
              </div>
