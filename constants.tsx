...
export const HOW_IT_WORKS_CLIENTS = [
  { icon: <Search className="w-8 h-8 text-blue-600" />, title: "Encontre Especialistas", desc: "Filtre pintores por localização, especialidade e portfólio real." },
  { icon: <Shield className="w-8 h-8 text-blue-600" />, title: "Verifique Avaliações", desc: "Veja fotos de antes e depois e opiniões de clientes reais." },
  { icon: <Calendar className="w-8 h-8 text-blue-600" />, title: "Contrate com Segurança", desc: "Agende sua obra e pague com a garantia de entrega da plataforma." }
];

export const HOW_IT_WORKS_PAINTERS = [
  { icon: <Wrench className="w-8 h-8 text-blue-600" />, title: "Crie seu Portfólio", desc: "Mostre seus melhores trabalhos em uma vitrine premium e profissional." },
  { icon: <Zap className="w-8 h-8 text-blue-600" />, title: "Receba Propostas", desc: "Seja encontrado por clientes qualificados em todo o Brasil." },
  { icon: <Award className="w-8 h-8 text-blue-600" />, title: "Construa sua Autoridade", desc: "Ganhe selos de verificação e destaque-se no mercado nacional." }
];
