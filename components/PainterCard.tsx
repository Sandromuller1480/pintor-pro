    ...
    <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 group flex flex-col h-full">
      <div className="relative h-40 overflow-hidden">
        ...
        <div className="absolute top-4 left-4 flex gap-2">
          {painter.verified && (
            <span className="bg-white/90 backdrop-blur-sm text-blue-600 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider flex items-center shadow-sm">
              <Shield className="w-3 h-3 mr-1" /> Verificado
            </span>
          )}
          {painter.topRated && (
            <span className="bg-blue-600 text-white px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider flex items-center shadow-sm">
      ...
      <div className="p-6 flex-grow flex flex-col">
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex items-center bg-blue-50 px-2 py-1 rounded-md">
            <Star className="w-3.5 h-3.5 text-blue-600 fill-blue-600 mr-1" />
            <span className="text-sm font-bold text-blue-700">{painter.rating}</span>
            <span className="text-xs text-blue-400 ml-1">({painter.reviewsCount})</span>
          </div>
        </div>

        <h3 className="text-lg font-bold text-slate-900 group-hover:text-blue-600 transition-colors">{painter.name}</h3>
        ...
        <div className="mt-auto pt-4 border-t border-slate-50 flex items-center justify-between">
          ...
          <button 
            ...
            className="flex items-center text-sm font-bold text-blue-600 hover:text-blue-800 transition"
          >
