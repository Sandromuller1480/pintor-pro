...
export const PublicPainterMap: React.FC<PublicPainterMapProps> = ({
  ...
  const frameClassName = size === 'compact'
    ? 'rounded-[34px] bg-[linear-gradient(180deg,rgba(178,20,146,0.92)_0%,rgba(178,20,146,0.34)_42%,rgba(0,7,71,0.38)_56%,rgba(0,7,71,0.92)_100%)] p-[6px] shadow-[0_18px_48px_rgba(15,23,42,0.08)]'
